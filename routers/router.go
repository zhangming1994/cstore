...
func router() {
	...
	//学生管理背景路由
	beego.Router("/cstore/student/list", &controllers.SudentController{}, "*:ShowAll")
	beego.Router("/cstore/student/adds", &controllers.SudentController{}, "*:AddStudent")
	beego.Router("/cstore/student/del", &controllers.SudentController{}, "*:DeleteStudent")
	beego.Router("/cstore/student/sel", &controllers.SudentController{}, "*:SelectStudent")
	beego.Router("/cstore/student/update", &controllers.SudentController{}, "*:UpdateStudent")
